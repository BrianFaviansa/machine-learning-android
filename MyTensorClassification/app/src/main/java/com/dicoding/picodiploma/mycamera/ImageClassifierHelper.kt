...
class ImageClassifierHelper(
    ...
    fun classifyImage(image: ImageProxy) {
        ...
        val imageProcessor = ImageProcessor.Builder()
            .add(ResizeOp(224, 244, ResizeOp.ResizeMethod.NEAREST_NEIGHBOR))
            .add(CastOp(DataType.UINT8))
            .build()
        val tensorImage = imageProcessor.process(TensorImage.fromBitmap(toBitmapImage(image)))
    ...
    private fun toBitmapImage(image: ImageProxy): Bitmap {
